...
```{r}
dir <- "/home/vera/Desktop/DAVID_TFM/Dropbox/TFM/PROJECTS AND ANALYSIS/FIBROBLAST_SAMPLES/NO_FILTERED/SKIN/htseq"

# Use a samples.txt to create the table:
library(readr)
samples <- read_delim("samples_Fibroblast.txt", "\t", escape_double = FALSE, trim_ws = FALSE)
